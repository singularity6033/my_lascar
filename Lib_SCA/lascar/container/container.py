...
class Container:
    """
    Container class is an abstract class used to represent Side-Channel traces.
    ...
    def plot_leakage(self, key):
        from Lib_SCA.lascar.plotting import plot
...
class AbstractContainer(Container):
    ...
    - setting up situations with oscilloscope and DUT
    ...
    def generate_trace_batch(self, idx_begin, idx_end):
        ...
        for i, j in tqdm(enumerate(range(idx_begin, idx_end))):
    ...
    def __getitem__(self, key):
        """
        instance of this class can use [key] to access this function
