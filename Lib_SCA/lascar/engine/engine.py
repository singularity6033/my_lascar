...
class Engine:
    ...
    Any class inheriting from Engine must implement at least 3 methods:
        - _initialize(): called by the Session once before processing batches
    ...
    def initialize(self, session):
        """
        initialize method is called by the Session the engine is registered.
...
class MeanEngine(Engine):
    ...
    def _update(self, batch):
        """
        Update MeanEngine from batches.
